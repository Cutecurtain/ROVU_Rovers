...
public class Main {
    ...
    public static void main (String[] args) throws InterruptedException {
        ...
        */
        ...
        // Example room 1
        rooms.add(new Room(0, new Point2D.Double(-5,-5), new Rect(new Point2D.Double(0,0), new Point2D.Double(5,5))));

        // Example room 2
        rooms.add(new Room(0, new Point2D.Double(0,-5), new Rect(new Point2D.Double(0,0), new Point2D.Double(5,5))));

        // Example room 3
        rooms.add(new Room(0, new Point2D.Double(-5,0), new Rect(new Point2D.Double(0,0), new Point2D.Double(5,5))));

        // Example room 4
        rooms.add(new Room(0, new Point2D.Double(0,0), new Rect(new Point2D.Double(0,0), new Point2D.Double(5,5))));
